...
const GlobalStyle = () => (
  <>
    <link href="https://fonts.googleapimport { useState, useEffect, useCallback, useRef } from "react";
import { supabase, TABLES, logChange, sendNotification } from "./supabase";
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, PieChart, Pie, Cell, Legend } from "recharts";
...
const TABS = [
  ...
  {id:"about",        label:"About",           icon:"ℹ️",  group:"settings"},
];
...
}is.com/css2?family=Oxanium:wght@400;500;600;700;800&family=Source+Sans+3:wght@300;400;500;600&family=Source+Code+Pro:wght@400;600&display=swap" rel="stylesheet" />
    <style>{`
      * { box-sizing: border-box; margin: 0; padding: 0; }
      html, body, #root { height: 100%; }
      body { background: #eef2f7; overflow: hidden; font-family: 'Source Sans 3', sans-serif; }
